...
public class WhyAnderson extends CompetitorsChoose{
    private final WhyAndersonLocators locators = new WhyAndersonLocators();

    public WhyAnderson(String title, String subtitle, List<List<String>> articles){
...
class WhyAndersonLocators {
    private final String BASE = "//h2[contains(text(), 'Why Andersen')]/../../..";
    ...
    @Getter private final By CARDS_IMAGES = By.cssSelector("section:nth-child(5) article div svg use");
}