package com.andersenlab.autotests.site.page.techstack.frontend.javascript.blocks;
...
public class CostCalc {
    ...
    public CostCalc() {
        top = new CostCalcPlusMinus("//h3[contains(text(), 'Top JavaScript developers for your team')]//..//..");
