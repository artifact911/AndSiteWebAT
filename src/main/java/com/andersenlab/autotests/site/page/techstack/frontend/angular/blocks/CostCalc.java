package com.andersenlab.autotests.site.page.techstack.frontend.angular.blocks;
...
public class CostCalc {
    ...
    public CostCalc() {
        top = new CostCalcPlusMinus("//h3[contains(text(), 'Top Angular developers for your team')]//..//..");
