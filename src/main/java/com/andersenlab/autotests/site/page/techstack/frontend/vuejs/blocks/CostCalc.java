package com.andersenlab.autotests.site.page.techstack.frontend.vuejs.blocks;
...
public class CostCalc {
    ...
    public CostCalc() {
        top = new CostCalcPlusMinus("//h3[contains(text(), 'Top Vue.js developers for your team')]//..//..");
