package com.andersenlab.autotests.site.page.techstack.mobile.android.blocks;
...
public class CostCalc {
    ...
    public CostCalc() {
        top = new CostCalcPlusMinus("//h3[contains(text(), 'Top Android engineers for your team')]//..//..");
