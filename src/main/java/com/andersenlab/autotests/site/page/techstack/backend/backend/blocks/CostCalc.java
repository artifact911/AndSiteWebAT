package com.andersenlab.autotests.site.page.techstack.backend.backend.blocks;
...
public class CostCalc {
    ...
    public CostCalc() {
        top = new CostCalcPlusMinus("//p[contains(text(), 'Top Back-end developers for your team')]//..//..");
...
//        Wrap.clickUntouchable(top.getPlus().get(1), 0, 0);
    ...
    {
        Selenide.refresh();
        Wait().until(ExpectedConditions.visibilityOfElementLocated(top.getTITLE()));
