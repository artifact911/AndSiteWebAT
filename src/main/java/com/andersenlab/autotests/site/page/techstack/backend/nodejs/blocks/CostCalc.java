package com.andersenlab.autotests.site.page.techstack.backend.nodejs.blocks;
...
public class CostCalc {
    ...
    public CostCalc() {
        top = new CostCalcPlusMinus("//p[contains(text(), 'Top Node.JS developers for your team')]//..//..");
        other = new CostCalcPlusMinus("//p[contains(text(), 'Other specialists')]//..//..");
