...
@Getter
public class CUFooterElements implements CUFooterLocators {
    //top
    ...
    private SelenideElement CityVilnius = $(CITY_VILNIUS);
    private SelenideElement CityVilniusPointer = $(CITY_VILNIUS_POINTER);
    //right
    private SelenideElement ButtonSend = $(BUTTON_SEND_REQ);
