...
public interface RequestFormLocators {
    ...
    String BASE = "//div[contains(@class, 'modal-module--content')]";
    By TITLE_REQ = By.xpath(BASE + "//h3");
    By BUTTON_CLOSE_REQ = By.xpath(BASE + "//button[contains(@class, 'close')]");
    ...
    By HINT_MAIL_COOPER = By.xpath(BASE + "//p[@class='popup-info__text font-size-md']");
    By ASK_PHONE = By.xpath(BASE + "//input[@name='phone']//..");
    By ASK_MAIL = By.xpath(BASE + "//input[@name='phone']//..");
    ...
    By CHECKBOX_TO_PROTECT_I = By.cssSelector("section.modal-module--popup--1hVvE div.hint-module--wrapper--jyTiU >svg"); //By.xpath(BASE + "//label[contains(@class, 'checkbox')]/following-sibling::div/div/*");
