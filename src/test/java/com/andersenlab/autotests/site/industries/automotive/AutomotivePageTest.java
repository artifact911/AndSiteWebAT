package com.andersenlab.autotests.site.industries.automotive;
...
public class AutomotivePageTest extends BaseTest2 {

    private final Pages page = Pages.AUTOMOTIVE;
