package com.andersenlab.autotests.site.industries.ecommerce;
...
import com.andersenlab.autotests.site.page.industries.ecommerce.calculator.CalculatorEcommerce;
...
public class ECommercePageTest extends BaseTest2 {

    private final Pages page = Pages.E_COMMERCE;
    private final Country country = Country.NOT_SPECIFIED;

    private MainFormForLeads mainFormForLeads;
    private CalculatorEcommerce calculatorsIndustries;
    ...
    protected void beforeClass() {
        ...
        calculatorsIndustries = new CalculatorEcommerce();
    ...
    @TmsLink("5288253")
    @Test(description = "Отображение и функциональность блока с калькулятором Get a quote for your eLearning solution",
            groups = "Calculators group")
    public void calculatorTest() {
        calculatorsIndustries.checkTypeOfBusinessBlock();
        calculatorsIndustries.checkRevenueModelBlock();
        calculatorsIndustries.checkServicesSelectionBlock();
        calculatorsIndustries.checkOtherServicesSelectionBlock();
        calculatorsIndustries.checkBudgetEstimationBlock();
        calculatorsIndustries.checkGetPriceButton();
        calculatorsIndustries.checkSendFormBlock();
    }
