package com.andersenlab.autotests.site.industries.financialservices.fintech;
...
public class AndersenCryptocurrencyDevelopmentServicesPageTest extends BaseTest2 {

    private final Pages page = Pages.CRYPTO_CURRENCY_DEVELOPMENT_SERVICES;
