package com.andersenlab.autotests.site.industries.logistics.inventorymanagement;
...
public class InventoryManagementSoftwareDevelopmentPageTest extends BaseTest2 {

    private final Pages page = Pages.INVENTORY_MANAGEMENT_SOFTWARE_DEVELOPMENT;
