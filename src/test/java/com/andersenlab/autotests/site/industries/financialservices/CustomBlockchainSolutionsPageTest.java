package com.andersenlab.autotests.site.industries.financialservices;
...
public class CustomBlockchainSolutionsPageTest extends BaseTest2 {

    private final Pages page = Pages.CUSTOM_BLOCKCHAIN_SOFTWARE_DEVELOPMENT;
