...
public class HealthInformationSecurityAndCompliancePageTest extends BaseTest2 {

    private final Pages page = Pages.HEALTH_INFORMATION_SECURITY_AND_COMPLIANCE;
