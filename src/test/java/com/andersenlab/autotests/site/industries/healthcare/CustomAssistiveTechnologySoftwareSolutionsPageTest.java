...
public class CustomAssistiveTechnologySoftwareSolutionsPageTest extends BaseTest2 {

    private final Pages page = Pages.CUSTOM_ASSISTIVE_TECHNOLOGY_SOFTWARE_SOLUTIONS;
