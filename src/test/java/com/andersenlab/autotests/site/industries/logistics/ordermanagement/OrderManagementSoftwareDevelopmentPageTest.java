package com.andersenlab.autotests.site.industries.logistics.ordermanagement;
...
public class OrderManagementSoftwareDevelopmentPageTest extends BaseTest2 {

    private final Pages page = Pages.ORDER_MANAGEMENT_SOFTWARE_DEVELOPMENT;
