package com.andersenlab.autotests.site.industries.financialservices.insurance;
...
public class InsurancePageTest extends BaseTest2 {

    private final Pages page = Pages.FINANCIAL_SERVICES_INSURANCE;
