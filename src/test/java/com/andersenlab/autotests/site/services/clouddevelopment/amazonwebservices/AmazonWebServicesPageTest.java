package com.andersenlab.autotests.site.services.clouddevelopment.amazonwebservices;
...
public class AmazonWebServicesPageTest extends BaseTest2 {

    private final Pages page = Pages.AMAZON_WEB_SERVICES;
