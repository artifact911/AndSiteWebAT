...
public class SalesForceContactUsTest extends BaseTest2 {
    private RequestForm rf = new RequestForm("Contact us");
    ...
    private void doBefore() {
        new SoftDevReach(new RequestForm("Contact us")).getButtonReq().click();
        Warp.scrollToElement(new Intro(new Widgets[]{}).getEl().getHeading());//если не скроллиться вверх, то intercepted
    }
