package com.andersenlab.autotests.site.services.clouddevelopment;
...
public class CloudDevelopmentServicesPageTest extends BaseTest2 {

    private final Pages page = Pages.CLOUD_DEVELOPMENT_SERVICES;
