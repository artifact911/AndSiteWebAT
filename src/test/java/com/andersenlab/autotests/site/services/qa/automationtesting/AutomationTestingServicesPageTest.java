package com.andersenlab.autotests.site.services.qa.automationtesting;
...
public class AutomationTestingServicesPageTest extends BaseTest2 {

    private final Pages page = Pages.AUTOMATION_TESTING_SERVICES;
