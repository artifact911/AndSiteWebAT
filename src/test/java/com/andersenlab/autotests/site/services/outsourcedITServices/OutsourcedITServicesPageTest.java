package com.andersenlab.autotests.site.services.outsourcedITServices;
...
public class OutsourcedITServicesPageTest extends BaseTest2 {

    private final Pages page = Pages.OUTSOURCED_IT_SERVICES;
