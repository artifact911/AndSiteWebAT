package com.andersenlab.autotests.site.services.uiuxdesign;
...
public class UiUxDesignPageTest extends BaseTest2 {

    private final Pages page = Pages.UIUX_DESIGN;
    ...
    public void checkBlocks(){
        ...
        checkingThePresenceOfBlocks.checkAnyBlockForExistence(checkingThePresenceOfBlocks.getOurVideo());
