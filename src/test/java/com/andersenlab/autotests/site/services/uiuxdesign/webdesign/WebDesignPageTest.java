package com.andersenlab.autotests.site.services.uiuxdesign.webdesign;
...
public class WebDesignPageTest extends BaseTest2 {

    private final Pages page = Pages.WEB_DESIGN;
