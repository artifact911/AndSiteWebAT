package com.andersenlab.autotests.site.services.productdevelopment;
...
public class ProductDevelopmentServicesPageTest extends BaseTest2 {

    private final Pages page = Pages.PRODUCT_DEVELOPMENT_SERVICES;
