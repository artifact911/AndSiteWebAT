package com.andersenlab.autotests.site.services.uiuxdesign.graphicdesign;
...
public class GraphicDesignPageTest extends BaseTest2 {

    private final Pages page = Pages.GRAPHIC_DESIGN;
