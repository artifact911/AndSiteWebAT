package com.andersenlab.autotests.site.services.maintenance.outsourcedcallcenterservicessupport;
...
public class OutsourcedCallCenterServicesSupportPageTest extends BaseTest2 {

    private final Pages page = Pages.OUTSOURCED_CALL_CENTER;
