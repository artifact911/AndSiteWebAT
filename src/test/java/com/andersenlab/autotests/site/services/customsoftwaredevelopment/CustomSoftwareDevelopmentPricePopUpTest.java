...
import com.andersenlab.autotests.site.form.successwindow.SuccessRich2;
...
public class CustomSoftwareDevelopmentPricePopUpTest extends BaseTest2 {

    private Country country = Country.NOT_SPECIFIED;
    private Pages page = Pages.CUSTOM_SOFTWARE;

    private CalcForm rf = new CalcForm("Please, leave your contact details to receive the quote", new SuccessRich2(country));
