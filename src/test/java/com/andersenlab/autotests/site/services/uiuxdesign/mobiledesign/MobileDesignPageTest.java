package com.andersenlab.autotests.site.services.uiuxdesign.mobiledesign;
...
public class MobileDesignPageTest extends BaseTest2 {

    private final Pages page = Pages.MOBILE_DESIGN;
