package com.andersenlab.autotests.site.services.devops;
...
public class DevOpsServicesPageTest extends BaseTest2 {

    private final Pages page = Pages.DEVOPS_SERVICES;
