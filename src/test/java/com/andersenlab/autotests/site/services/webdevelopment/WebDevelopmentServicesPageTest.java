package com.andersenlab.autotests.site.services.webdevelopment;
...
public class WebDevelopmentServicesPageTest extends BaseTest2 {

    private final Pages page = Pages.WEB_DEVELOPMENT_SERVICES;
