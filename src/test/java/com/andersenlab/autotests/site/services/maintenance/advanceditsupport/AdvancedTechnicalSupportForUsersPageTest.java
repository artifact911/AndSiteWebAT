package com.andersenlab.autotests.site.services.maintenance.advanceditsupport;
...
public class AdvancedTechnicalSupportForUsersPageTest extends BaseTest2 {

    private final Pages page = Pages.ADVANCED_TECHNICAL_SUPPORT_FOR_USERS;
