package com.andersenlab.autotests.site.services.solutionsrchitecture;
...
public class SolutionArchitectureServicesPageTest extends BaseTest2 {

    private final Pages page = Pages.SOLUTION_ARCHITECTURE_SERVICES;
