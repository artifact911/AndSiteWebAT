package com.andersenlab.autotests.site.services.uiuxdesign.brandingdesign;
...
public class BrandingDesignPageTest extends BaseTest2 {

    private final Pages page = Pages.BRANDING_DESIGN;
