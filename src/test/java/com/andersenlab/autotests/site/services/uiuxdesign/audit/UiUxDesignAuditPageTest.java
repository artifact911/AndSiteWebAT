package com.andersenlab.autotests.site.services.uiuxdesign.audit;
...
public class UiUxDesignAuditPageTest extends BaseTest2 {

    private final Pages page = Pages.UIUX_DESIGN_AUDIT;
    ...
    @TmsLink("5678817")
    @Test(description = "[EN] Отображение и функциональность контактной формы в блоке с буллетами, где текст кнопки 'Request specialist'", priority = 10, groups = "Checking the main form for leads")
