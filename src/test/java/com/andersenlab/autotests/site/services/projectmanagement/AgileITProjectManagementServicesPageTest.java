package com.andersenlab.autotests.site.services.projectmanagement;
...
public class AgileITProjectManagementServicesPageTest extends BaseTest2 {

    private final Pages page = Pages.AGILE_IT_PROJECT_MANAGEMENT;
    ...
    @TmsLink("5678913")
    @Test(description = "[EN] Отображение и функциональность контактной формы в блоке с буллетами, где текст кнопки 'Request PM Specialist'", priority = 10, groups = "Checking the main form for leads")
    public void checkMainFormForLeads(){
        mainFormForLeads.scrollToButtonAndCheckTitle(mainFormForLeads.getButtonInMainModule(), "Request PM Specialist");
