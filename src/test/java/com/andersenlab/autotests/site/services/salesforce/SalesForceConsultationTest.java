...
public class SalesForceConsultationTest extends BaseTest2 {
    private ConsultationForm rf = new ConsultationForm("Contact us for a free consultation on Salesforce");
...
//TODO переделать тесты с БД(не через UI)
    @TmsLink("5252412")
