...
public class MobileDevelopmentConsultationTest extends BaseTest2 {
    private ConsultationForm rf = new ConsultationForm("Contact us for a free consultation on Mobile Development");
