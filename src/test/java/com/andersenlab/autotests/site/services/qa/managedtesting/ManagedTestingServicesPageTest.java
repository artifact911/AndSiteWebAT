package com.andersenlab.autotests.site.services.qa.managedtesting;
...
public class ManagedTestingServicesPageTest extends BaseTest2 {

    private final Pages page = Pages.MANAGED_TESTING_SERVICES;
