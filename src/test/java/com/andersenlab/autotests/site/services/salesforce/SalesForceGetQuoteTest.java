...
public class SalesForceGetQuoteTest extends BaseTest2 {
    private RequestForm rf = new RequestForm("Get a quote");
    ...
    @TmsLink("5252418")//TODO переделать тесты с БД(не через UI)
