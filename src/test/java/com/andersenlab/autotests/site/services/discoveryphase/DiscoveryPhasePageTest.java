package com.andersenlab.autotests.site.services.discoveryphase;
...
public class DiscoveryPhasePageTest extends BaseTest2 {

    private final Pages page = Pages.DISCOVERY_PHASE_FOR_SOFTWARE_PROJECT;
