...
import com.andersenlab.autotests.site.page.techstack.frontend.javascript.PageTextsJavascript;
import com.andersenlab.autotests.site.page.techstack.frontend.javascript.blocks.CostCalc;
import com.andersenlab.autotests.site.page.techstack.frontend.javascript.blocks.CustomerReviewsDataJavascript;
...
public class JavascriptPageTest extends BaseTest2 {
    ...
    @TmsLink("5280388")
    @Test(description = "Отображение и функциональность блока 'Work with Top JavaScript Developers'", priority = 10)
    ...
    public void checkCallToAction(){
        String title = "Whether you are in the early stage or have an ongoing project, our professional JavaScript solution architects are always ready to consult and guide you within the development process. Schedule a free online consultation with our specialist.";
    ...
    @TmsLink("5366578")
    @Test(description = "Отображение и функционал блока 'Testimonials'", priority = 80, enabled = true) //будут переделывать список отзывов
    public void displayingFunctionCustomerReviews() {
        CustomerReviews b = new CustomerReviews(new CustomerReviewsDataJavascript());
        b.displayingElements();
    }
    ...
    public void displayingTitle() {
        Page b = new Page(new PageTextsJavascript());
        b.displayingTitle();
    }
