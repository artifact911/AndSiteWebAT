package com.andersenlab.autotests.site.techstack.mobile.mobile;
...
import com.andersenlab.autotests.site.page.techstack.mobile.mobile.blocks.CustomerReviewsDataMobile;
import com.andersenlab.autotests.site.page.techstack.mobile.mobile.PageTextsMobile;
import com.andersenlab.autotests.site.page.techstack.mobile.mobile.blocks.CostCalc;
...
public class MobilePageTest extends BaseTest2 {
    private final Pages page = Pages.MOBILE;
    ...
    @TmsLink("5294838")
    @Test(description = "Отображение и функциональность блока 'Work With Top Mobile Developers'", priority = 10) //fixme виджеты с другими аттрибутами. Придумать решение
    ...
    @TmsLink("")
    @Test(description = "Отображение и функционал блока с буллитами 'Get your Mobile specialists...'", priority = 20)
    ...
    @TmsLink("5344972")
    @Test(description = "Отображение и функциональность блока 'Expert custom solutions..'", priority = 70)
    ...
    public void displayingFunctionCustomerReviews() {
        CustomerReviews b = new CustomerReviews(new CustomerReviewsDataMobile());
        b.displayingElements();
    }
    ...
    public void displayingTitle() {
        Page b = new Page(new PageTextsMobile());
        b.displayingTitle();
    }
