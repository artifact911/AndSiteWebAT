package com.andersenlab.autotests.site.techstack.mobile.reactnative;
...
import com.andersenlab.autotests.site.page.techstack.mobile.reactnative.PageTextsReactNative;
import com.andersenlab.autotests.site.page.techstack.mobile.reactnative.blocks.CostCalc;
import com.andersenlab.autotests.site.page.techstack.mobile.reactnative.blocks.CustomerReviewsReactNative;
...
public class ReactNativePageTest extends BaseTest2 {
    private final Pages page = Pages.REACT_NATIVE;
    ...
    @TmsLink("5294842")
    @Test(description = "Отображение и функциональность блока 'Work With Top React Native Developers'", priority = 10)
    ...
    @TmsLink("")
    @Test(description = "Отображение и функционал блока с буллитами 'Get your React Native specialists...'", priority = 20)
    ...
    public void checkCallToAction(){
        String title = "Whether you are in the early stage or have an ongoing project, our professional React Native solution architects are always ready to consult and guide you within the development process. Schedule a free online consultation with our specialist.";
    ...
    @TmsLink("5276640")
    @Test(description = "Отображение и функциональность блока 'Our engineers'", priority = 50, enabled = true)//CV пока не работают
    ...
    public void displayingFunctionCustomerReviews() {
        CustomerReviews b = new CustomerReviews(new CustomerReviewsReactNative());
        b.displayingElements();
    }
    ...
    public void displayingTitle() {
        Page b = new Page(new PageTextsReactNative());
        b.displayingTitle();
    }
