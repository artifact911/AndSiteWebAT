...
public class BackEndPageTest extends BaseTest2 {
    ...
    @TmsLink("5293890")
    @Test(description = "Отображение и функциональность блока 'Work With Top Back-End Developers'", priority = 10)
    ...
    @TmsLink("5293892")
    @Test(description = "Отображение и функционал блока с буллитами 'Get your Back-End specialists...'", priority = 20)
