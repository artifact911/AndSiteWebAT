...
import com.andersenlab.autotests.site.page.techstack.backend.ccpp.PageTextsCAndCpp;
import com.andersenlab.autotests.site.page.techstack.backend.ccpp.blocks.CostCalc;
import com.andersenlab.autotests.site.page.techstack.backend.ccpp.blocks.CustomerReviewsDataCAndCpp;
...
public class CCPPPageTest extends BaseTest2 {
    ...
    @TmsLink("5294836")
    @Test(description = "Отображение и функциональность блока 'Work With Top C/C++ Developers'", priority = 10)
    ...
    @TmsLink("")
    @Test(description = "Отображение и функционал блока с буллитами 'Get your C/C++ specialists...'", priority = 20)
    ...
    public void displayingFunctionCustomerReviews() {
        CustomerReviews b = new CustomerReviews(new CustomerReviewsDataCAndCpp());
        b.displayingElements();
    }
    ...
    public void displayingTitle() {
        Page b = new Page(new PageTextsCAndCpp());
        b.displayingTitle();
    }
