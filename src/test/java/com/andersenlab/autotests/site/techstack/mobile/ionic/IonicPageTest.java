...
import com.andersenlab.autotests.site.page.techstack.mobile.ionic.PageTextsIonic;
import com.andersenlab.autotests.site.page.techstack.mobile.ionic.blocks.CostCalc;
import com.andersenlab.autotests.site.page.techstack.mobile.ionic.blocks.CustomerReviewsDataIonic;
...
public class IonicPageTest extends BaseTest2 {
    ...
    @TmsLink("5294844")
    @Test(description = "Отображение и функциональность блока 'Work With Top Ionic Developers'", priority = 10)
    ...
    @TmsLink("")
    @Test(description = "Отображение и функционал блока с буллитами 'Get your Ionic specialists...'", priority = 20)
    ...
    public void displayingFunctionCustomerReviews() {
        CustomerReviews b = new CustomerReviews(new CustomerReviewsDataIonic());
        b.displayingElements();
    }
    ...
    public void displayingTitle() {
        Page b = new Page(new PageTextsIonic());
        b.displayingTitle();
    }
