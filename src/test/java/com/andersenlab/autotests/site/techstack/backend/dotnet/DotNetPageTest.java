...
import com.andersenlab.autotests.site.page.techstack.backend.dotnet.PageTextsDotNet;
import com.andersenlab.autotests.site.page.techstack.backend.dotnet.blocks.CostCalc;
import com.andersenlab.autotests.site.page.techstack.backend.dotnet.blocks.CustomerReviewsDataDotNet;
...
public class DotNetPageTest extends BaseTest2 {
    ...
    @TmsLink("5294829")
    @Test(description = "Отображение и функциональность блока 'Work With Top .Net Developers'", priority = 10)
    ...
    @TmsLink("")
    @Test(description = "Отображение и функционал блока с буллитами 'Get your .Net specialists...'", priority = 20)
    ...
    public void displayingFunctionCustomerReviews() {
        CustomerReviews b = new CustomerReviews(new CustomerReviewsDataDotNet());
        b.displayingElements();
    }
    ...
    public void displayingTitle() {
        Page b = new Page(new PageTextsDotNet());
        b.displayingTitle();
    }
