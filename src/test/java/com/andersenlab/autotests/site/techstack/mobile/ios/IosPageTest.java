...
import com.andersenlab.autotests.site.page.techstack.mobile.ios.PageTextsIos;
import com.andersenlab.autotests.site.page.techstack.mobile.ios.blocks.CostCalc;
import com.andersenlab.autotests.site.page.techstack.mobile.ios.blocks.CustomerReviewsDataIos;
...
public class IosPageTest extends BaseTest2 {
    ...
    @TmsLink("5294840")
    @Test(description = "Отображение и функциональность блока 'Work With Top iOS Developers'", priority = 10)
    ...
    @TmsLink("")
    @Test(description = "Отображение и функционал блока с буллитами 'Get your iOS specialists...'", priority = 20)
    ...
    public void checkCallToAction(){
        String title = "Whether you are in the early stage or have an ongoing project, our professional iOS solution architects are always ready to consult and guide you within the development process. Schedule a free online consultation with our specialist.";
    ...
    public void displayingFunctionCustomerReviews() {
        CustomerReviews b = new CustomerReviews(new CustomerReviewsDataIos());
        b.displayingElements();
    }
    ...
    public void displayingTitle() {
        Page b = new Page(new PageTextsIos());
        b.displayingTitle();
    }
