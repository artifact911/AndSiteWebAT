package com.andersenlab.autotests.site.techstack.mobile.android;
...
import com.andersenlab.autotests.site.page.techstack.mobile.android.PageTextsAndroid;
import com.andersenlab.autotests.site.page.techstack.mobile.android.blocks.CostCalc;
import com.andersenlab.autotests.site.page.techstack.mobile.android.blocks.CustomerReviewsDataAndroid;
...
public class AndroidPageTest extends BaseTest2 {
    private final Pages page = Pages.ANDROID;
    ...
    @TmsLink("5294839")
    @Test(description = "Отображение и функциональность блока 'Work With Top Android Developers'", priority = 10)
    ...
    @TmsLink("")
    @Test(description = "Отображение и функционал блока с буллитами 'Get your Android specialists...'", priority = 20)
    ...
    public void checkCallToAction(){
        String title = "Whether you are in the early stage or have an ongoing project, our professional Android solution architects are always ready to consult and guide you within the development process. Schedule a free online consultation with our specialist.";
    ...
    public void displayingFunctionCustomerReviews() {
        CustomerReviews b = new CustomerReviews(new CustomerReviewsDataAndroid());
        b.displayingElements();
    }
    ...
    public void displayingTitle() {
        Page b = new Page(new PageTextsAndroid());
        b.displayingTitle();
    }
