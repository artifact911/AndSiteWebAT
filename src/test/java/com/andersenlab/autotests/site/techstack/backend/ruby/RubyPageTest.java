package com.andersenlab.autotests.site.techstack.backend.ruby;
...
import com.andersenlab.autotests.site.page.techstack.backend.ruby.PageTextsRuby;
import com.andersenlab.autotests.site.page.techstack.backend.ruby.blocks.CostCalc;
import com.andersenlab.autotests.site.page.techstack.backend.ruby.blocks.CustomerReviewsDataRuby;
...
public class RubyPageTest extends BaseTest2 {
    private final Pages page = Pages.RUBY;
    ...
    @TmsLink("")
    @Test(description = "Отображение и функционал блока с буллитами 'Get your Ruby specialists...'", priority = 20)
    ...
    public void displayingFunctionCustomerReviews() {
        CustomerReviews b = new CustomerReviews(new CustomerReviewsDataRuby());
        b.displayingElements();
    }
    ...
    public void displayingTitle() {
        Page b = new Page(new PageTextsRuby());
        b.displayingTitle();
    }
