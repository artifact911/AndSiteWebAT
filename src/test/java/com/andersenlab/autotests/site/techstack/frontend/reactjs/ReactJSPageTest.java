package com.andersenlab.autotests.site.techstack.frontend.reactjs;
...
import com.andersenlab.autotests.site.page.techstack.frontend.reactjs.PageTextsReactJS;
import com.andersenlab.autotests.site.page.techstack.frontend.reactjs.blocks.CostCalc;
import com.andersenlab.autotests.site.page.techstack.frontend.reactjs.blocks.CustomerReviewsDataReactJS;
...
public class ReactJSPageTest extends BaseTest2 {
    private final Pages page = Pages.REACT_JS;
    ...
    @TmsLink("5294826")
    @Test(description = "Отображение и функциональность блока 'Work With Top React.JS Developers'", priority = 10)
    ...
    @TmsLink("")
    @Test(description = "Отображение и функционал блока с буллитами 'Get your React.JS specialists...'", priority = 20)
    ...
    public void checkCallToAction(){
        String title = "Whether you are in the early stage or have an ongoing project, our professional React.js solution architects are always ready to consult and guide you within the development process. Schedule a free online consultation with our specialist.";
    ...
    public void displayingFunctionCustomerReviews() {
        CustomerReviews b = new CustomerReviews(new CustomerReviewsDataReactJS());
        b.displayingElements();
    }
    ...
    public void displayingTitle() {
        Page b = new Page(new PageTextsReactJS());
        b.displayingTitle();
    }
