package com.andersenlab.autotests.site.techstack.backend.scala;
...
import com.andersenlab.autotests.site.page.techstack.backend.scala.PageTextsScala;
import com.andersenlab.autotests.site.page.techstack.backend.scala.blocks.CostCalc;
import com.andersenlab.autotests.site.page.techstack.backend.scala.blocks.CustomerReviewsDataScala;
...
public class ScalaPageTest extends BaseTest2 {
    private final Pages page = Pages.SCALA;
    ...
    @TmsLink("5294834")
    @Test(description = "Отображение и функциональность блока 'Work With Top Scala Developers'", priority = 10)
    ...
    @TmsLink("")
    @Test(description = "Отображение и функционал блока с буллитами 'Get your Scala specialists...'", priority = 20)
    ...
    public void displayingFunctionCustomerReviews() {
        CustomerReviews b = new CustomerReviews(new CustomerReviewsDataScala());
        b.displayingElements();
    }
    ...
    public void displayingTitle() {
        Page b = new Page(new PageTextsScala());
        b.displayingTitle();
    }
