...
import com.andersenlab.autotests.site.page.techstack.frontend.frontend.blocks.CostCalc;
...
public class FrontEndPriceInCalcTest extends BaseTest2 {
    ...
    @TmsLink("5274210")//TODO переделать тесты с БД(не через UI)
