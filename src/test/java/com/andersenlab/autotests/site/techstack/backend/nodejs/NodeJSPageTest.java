package com.andersenlab.autotests.site.techstack.backend.nodejs;
...
import com.andersenlab.autotests.site.page.techstack.backend.nodejs.PageTextsNodeJS;
import com.andersenlab.autotests.site.page.techstack.backend.nodejs.blocks.CostCalc;
import com.andersenlab.autotests.site.page.techstack.backend.nodejs.blocks.CustomerReviewsDataNodeJS;
...
public class NodeJSPageTest extends BaseTest2 {
    private final Pages page = Pages.NODE_JS;
    ...
    @TmsLink("5294833")
    @Test(description = "Отображение и функциональность блока 'Work With Top Node.js Developers'", priority = 10)
    ...
    @TmsLink("")
    @Test(description = "Отображение и функционал блока с буллитами 'Get your Node.js specialists...'", priority = 20)
    ...
    public void displayingFunctionCustomerReviews() {
        CustomerReviews b = new CustomerReviews(new CustomerReviewsDataNodeJS());
        b.displayingElements();
    }
    ...
    public void displayingTitle() {
        Page b = new Page(new PageTextsNodeJS());
        b.displayingTitle();
    }
