...
public class AboutUsPageTest extends BaseTest2 {

    private final Pages page = Pages.ABOUT_US;
    ...
    public void checkBlocks(){
        ...
        checkingThePresenceOfBlocks.checkAnyBlockForExistence(checkingThePresenceOfBlocks.getOurOffices());
    }
}
